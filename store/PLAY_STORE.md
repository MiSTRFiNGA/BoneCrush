...
**Web:** https://mistrfinga.github.io/BoneCrush/  
...
Measured on HiVEMiND `D:\Dev\_mobile\bonecrush\android\variables.gradle` (2026-07-30):
...
| `targetSdkVersion` | **36** |
| `applicationId` | `com.empiregames.bonecrush` |
...
| Intended public URL | **https://mistrfinga.github.io/BoneCrush/privacy/** |
...
Orientation primary: **portrait**. Genre: **Puzzle / Match-3**.
...
• Also on the web: https://mistrfinga.github.io/BoneCrush/

Privacy: https://mistrfinga.github.io/BoneCrush/privacy/
```
...
- Package name for this title: `com.empiregames.bonecrush`
...
3. `pwsh D:\Dev\_mobile\build_apk.ps1 -Game BoneCrush -Version X.Y`  
4. Create Play app with applicationId `com.empiregames.bonecrush`  
