# Mobile packaging notes — Bone Crush
...
```powershell
pwsh -File D:\Dev\_mobile\build_apk.ps1 -Game BoneCrush -Version 1.0
```

- Capacitor project lives under `D:\Dev\_mobile\bonecrush\` (not committed to this public repo).
